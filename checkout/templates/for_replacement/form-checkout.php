...
function generate_section_change_button_html( $target_section_number, $section, $direction ) {
  ...
  $button_inner_html = sprintf(__( "Go to %s", 'ws_woocommerce_checkout_plugin' ), $section['label']);
	if( 'next' == $direction ) {
...
$sections = [ [ 'name' => 'cart', 'label' => esc_html__( 'Cart', 'woocommerce' ) ], [ 'name' => 'info', 'label' => esc_html__( 'Information', 'ws_woocommerce_checkout_plugin' ) ], [ 'name' => 'shipping', 'label' => esc_html__( 'Shipping', 'woocommerce' ) ], [ 'name' => 'payment', 'label' => esc_html__( 'Payment', 'woocommerce' ) ], [ 'name' => 'complete', 'label' => esc_html__( 'Complete', 'ws_woocommerce_checkout_plugin' )] ]; 
...
?>
<span id="custom-checkout-page-cart-url-container" data-cart-url="<?php echo wc_get_cart_url(); ?>"></span>
<div id="custom-checkout-page-section-button-containers-container">
	<div data-this-section-number="0" class="custom-checkout-page-section-button-container custom-checkout-page-section-change-button-any">
		...
		<span class="custom-checkout-page-section-button-label"><?php echo $sections[ 0 ][ 'label' ] ?></span>
	</div>
	<?php for( $i = 1; $i < count( $sections ) - 1; $i++ ) : ?>
		<div id="custom-checkout-page-section-change-button-any-<?php echo $i; ?>" class="custom-checkout-page-section-button-container custom-checkout-page-section-change-button-any" data-this-section-number="<?php echo $i ?>">
			<div class="button custom-checkout-page-section-button-number"><?php echo $i + 1 ?></div>
			<span class="custom-checkout-page-section-button-label"><?php echo $sections[ $i ][ 'label' ] ?></span>
		</div>
	<?php endfor; ?>	
	<div class="custom-checkout-page-section-button-container" id="custom-checkout-page-section-complete-button-container">
		...
		<span class="custom-checkout-page-section-button-label"><?php echo $sections[ count( $sections ) - 1 ][ 'label' ] ?></span>
	</div>
</div>
<div id="custom-checkout-page-form-container">
	<form name="checkout" method="post" class="checkout woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
		<div id="custom-checkout-page-sections">
			<section id="custom-checkout-page-<?php echo $counter_for_preserving_section_names; ?>-section" class="custom-checkout-page-section">
				<h2><?php echo $sections[ $counter_for_preserving_section_names ][ 'label' ]; ?></h2>
			...
			<section id="custom-checkout-page-<?php echo $counter_for_preserving_section_names; ?>-section" class="custom-checkout-page-section">
				...
				<div>
					...
					<div class="section-change-buttons-container">
						<?php echo generate_section_change_button_html( $counter_for_preserving_section_names - 1, $sections[ $counter_for_preserving_section_names - 1 ], 'previous' ); ?>
						<?php echo generate_section_change_button_html( $counter_for_preserving_section_names + 1, $sections[ $counter_for_preserving_section_names + 1], 'next' ); ?>
					</div>
				</div>
				<?php $counter_for_preserving_section_names++; ?>
