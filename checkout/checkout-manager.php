...
class Web_Systems_Custom_Woocommerce_Checkout_Checkout_Manager {
    ...
    private function enqueue_checkout_scripts() {
        ...
        $script_name = 'sections';                
            wp_register_script( "web_systems_custom_woocommerce_checkout-js-checkout-{$script_name}", WS_WOOCOMMERCE_CHECKOUT_PLUGIN_DIR_URL . "checkout/js/{$script_name}.js", [ 'jquery'], false, true );//in_footer
        ...
        wp_register_script( 'web_systems_custom_woocommerce_checkout-js-checkout-sections', WS_WOOCOMMERCE_CHECKOUT_PLUGIN_DIR_URL . 'checkout/js/sections.js', $sections_js_dependencies, false, true );//in_footer
        ...
        wp_register_script( 'web_systems_custom_woocommerce_checkout-js-checkout-swipe', WS_WOOCOMMERCE_CHECKOUT_PLUGIN_DIR_URL . 'checkout/js/swipe.js', [ 'jquery'  ], false, true );//in_footer
        wp_enqueue_script( 'web_systems_custom_woocommerce_checkout-js-checkout-swipe' );


        wp_register_script( 'web_systems_custom_woocommerce_checkout-js-checkout-sections', WS_WOOCOMMERCE_CHECKOUT_PLUGIN_DIR_URL . 'checkout/js/sections.js', [ 'jquery', 'web_systems_custom_woocommerce_checkout-js-checkout-swipe'  ], false, true );//in_footer
        wp_enqueue_script( 'web_systems_custom_woocommerce_checkout-js-checkout-sections' );
  
        if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) {
            $script_name = 'shipping';           
            wp_register_script( 'web_systems_custom_woocommerce_checkout-js-checkout-shipping', WS_WOOCOMMERCE_CHECKOUT_PLUGIN_DIR_URL . 'checkout/js/shipping.js', [ 'web_systems_custom_woocommerce_checkout-js-checkout-sections' ], false, true );//in_footer
            wp_enqueue_script( 'web_systems_custom_woocommerce_checkout-js-checkout-shipping' );
        }
    }
    private function enqueue_checkout_styles() {   
        wp_register_style( 'web_systems_custom_woocommerce_checkout-css-checkout-sections', WS_WOOCOMMERCE_CHECKOUT_PLUGIN_DIR_URL . 'checkout/css/sections.css' );
